...
def calculate_total_amount(items, quantities, prices,applying_discount, taxes, splitting_bill):
    ...
    if splitting_bill:
        prices /= 2
    return items*prices*quantities+taxes

        

taxes = 0.01
items = int(input("Enter The Ordered Items? "))
...
total_bill = calculate_total_amount(items, quantities, prices, applying_discount, taxes, splitting_bill )
